...
(function() {
  var FALSE, Franz, TRUE, byArray, byImage, cbr, clamp, copy, crop, fff, fffr, getGrayscaleValue, getToolbox, hardResize, ifw, isFunction, mF, make, nb, newToolbox, resize, rgba, scale, toArray, toImage,
    __slice = [].slice;
